...
#import "YFTMKReverseGeocoder.h"
#import "JSON.h"
#import "YFTMKPlacemark+Private.h"


@interface YFTMKReverseGeocoder (WebViewIntegration)
...
@interface YFTMKReverseGeocoder (Private)
...
@implementation YFTMKReverseGeocoder
...
- (void)webView:(WebView *)sender didClearWindowObject:(WebScriptObject *)windowScriptObject forFrame:(WebFrame *)frame
{
    ...
    [windowScriptObject setValue:self forKey:@"YFTMKReverseGeocoder"];
}
...
{
    //NSLog(@"didFinishLoad:");
    [[webView windowScriptObject] setValue:self forKey:@"YFTMKReverseGeocoder"];
    webViewLoaded = YES;
...
- (void)createWebView
{
    ...
    NSBundle *frameworkBundle = [NSBundle bundleForClass:[YFTMKReverseGeocoder class]];
