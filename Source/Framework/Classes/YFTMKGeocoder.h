...
@protocol YFTMKGeocoderDelegate;

@interface YFTMKGeocoder : NSObject {
    id <YFTMKGeocoderDelegate> __strong delegate;
    NSString *address;
...
@property (nonatomic, strong) id<YFTMKGeocoderDelegate> delegate;
...
@protocol YFTMKGeocoderDelegate <NSObject>
@required
