...
#import "YFTMKCircle.h"

@interface YFTMKCircle (Private)
...
@implementation YFTMKCircle

@synthesize coordinate, radius;

+ (YFTMKCircle *)circleWithCenterCoordinate:(CLLocationCoordinate2D)aCoord radius:(CLLocationDistance)aRadius
{
...
{
    YFTMKCoordinateRegion theRegion;
