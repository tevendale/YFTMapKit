...
#import "YFTMKPolygonView.h"
#import <CoreLocation/CoreLocation.h>

@interface YFTMKPolygonView (Private)

- (NSArray *)pathForPolygon:(YFTMKPolygon *)aPolygon webScriptObject:(WebScriptObject *)webScriptObject;

@end


@implementation YFTMKPolygonView
...
- (void)draw:(WebScriptObject *)overlayScriptObject
{
    if (!path)
    {
        ...
        if ([self polygon].interiorPolygons)
        {
            ...
            for (YFTMKPolygon *aPolygon in [self polygon].interiorPolygons)
            {
