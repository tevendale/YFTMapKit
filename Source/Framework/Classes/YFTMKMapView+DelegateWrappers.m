...
@implementation YFTMKMapView (DelegateWrappers)
...
- (void)delegateAnnotationView:(YFTMKAnnotationView *)annotationView 
            didChangeDragState:(YFTMKAnnotationViewDragState)newState
                  fromOldState:(YFTMKAnnotationViewDragState)oldState
{
