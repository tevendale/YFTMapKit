...
@implementation YFTMKMapView (Private)
...
- (void)customInit
{
    ...
    if (!webView)
    {
        webView = [[YFTMKWebView alloc] initWithFrame:[self bounds]];
    }
    ...
    userLocation = [[YFTMKUserLocation alloc] init];
}

- (void)loadMapKitHtml
{
    // TODO : make this suck less.
    NSBundle *frameworkBundle = [NSBundle bundleForClass:[YFTMKMapView class]];
